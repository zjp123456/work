...
from
    wap_nginx_log
where
    dt<='2015-03-17' and dt>='2015-03-12'
...
(
select access_token,device_id,dt from mobile_app_log_new_orc where dt<='2015-03-17' and dt>='2015-03-12' group by access_token,device_id,dt
